...
import com.gacrnd.gcs.webview.BuildConfig;
...
public class WebDefaultSettings {
    ...
    private static volatile WebDefaultSettings mInstance;

    public static WebDefaultSettings getInstance() {
        if (mInstance == null) {
            synchronized (WebDefaultSettings.class) {
                if (mInstance == null) {
                    mInstance = new WebDefaultSettings();
                }
            }
        }
        return mInstance;
